...
public class LERPcarMovementRight : MonoBehaviour
{
    ...
    void Update()
    {
        //unlike what i did with the variables i ended up making two scripts for the left and right cars so clicking A in this sets drive to false but in the other script it sets it to true 
